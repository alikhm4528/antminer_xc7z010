...
proc cr_bd_system { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {NAND Flash#GPIO#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.451389",
   "Default View_TopLeft":"0,-153",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1150 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1150 -y 330 -defaultsOSRD
preplace port gpio_rtl_0 -pg 1 -lvl 4 -x 1150 -y 140 -defaultsOSRD
preplace port FCLK_CLK0 -pg 1 -lvl 4 -x 1150 -y 370 -defaultsOSRD
preplace port FCLK_RESET0_N_0 -pg 1 -lvl 4 -x 1150 -y 390 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 3 -x 920 -y 350 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 920 -y 140 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 560 -y 120 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 210 -y 350 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 20 250 390 250 710 450 1130
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 4 20 460 NJ 460 NJ 460 1120
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 400 260 720
preplace netloc processing_system7_0_DDR 1 3 1 NJ 310
preplace netloc processing_system7_0_FIXED_IO 1 3 1 NJ 330
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ 140
preplace netloc processing_system7_0_M_AXI_GP0 1 1 3 410 240 NJ 240 1130
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 120
levelinfo -pg 1 0 210 560 920 1150
pagesize -pg 1 -db -bbox -sgen 0 0 1340 470
"
}
