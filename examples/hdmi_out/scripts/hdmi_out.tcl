...
# Create project
create_project -force ${_xil_proj_name_} ${base_dir}/${_xil_proj_name_} -part xc7z010clg400-1
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/repo/vivado-library"]" $obj
...
proc cr_bd_system { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {NAND Flash#GPIO#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rst_ps7_0_40M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tpg_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_40M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_0_40M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_40M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_40M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins rst_ps7_0_40M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.456288",
   "Default View_TopLeft":"-31,-285",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1910 -y 280 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1910 -y 300 -defaultsOSRD
preplace port TMDS_Clk_p_0 -pg 1 -lvl 6 -x 1910 -y 110 -defaultsOSRD
preplace port TMDS_Clk_n_0 -pg 1 -lvl 6 -x 1910 -y 130 -defaultsOSRD
preplace portBus TMDS_Data_p_0 -pg 1 -lvl 6 -x 1910 -y 150 -defaultsOSRD
preplace portBus TMDS_Data_n_0 -pg 1 -lvl 6 -x 1910 -y 170 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 200 -y 320 -defaultsOSRD
preplace inst rgb2dvi_0 -pg 1 -lvl 5 -x 1720 -y 150 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 600 -y 150 -defaultsOSRD
preplace inst rst_ps7_0_40M -pg 1 -lvl 1 -x 200 -y 110 -defaultsOSRD
preplace inst v_axi4s_vid_out_0 -pg 1 -lvl 4 -x 1360 -y 140 -defaultsOSRD
preplace inst v_tc_0 -pg 1 -lvl 3 -x 1000 -y 120 -defaultsOSRD
preplace inst v_tpg_0 -pg 1 -lvl 3 -x 1000 -y 380 -defaultsOSRD -resize 302 236
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 -10 10 420 20 770 210 1210 260 1520J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 210 400
preplace netloc rst_ps7_0_40M_peripheral_aresetn 1 1 4 410 30 780 30 1200 20 1530J
preplace netloc rst_ps7_0_40M_interconnect_aresetn 1 1 1 N 130
preplace netloc v_axi4s_vid_out_0_vtg_ce 1 2 3 790 10 NJ 10 1510
preplace netloc rgb2dvi_0_TMDS_Clk_p 1 5 1 1860 110n
preplace netloc rgb2dvi_0_TMDS_Clk_n 1 5 1 1870 130n
preplace netloc rgb2dvi_0_TMDS_Data_p 1 5 1 1880 150n
preplace netloc rgb2dvi_0_TMDS_Data_n 1 5 1 1890 170n
preplace netloc v_tc_0_vtiming_out 1 3 1 1190 100n
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 430 90n
preplace netloc processing_system7_0_DDR 1 1 5 NJ 270 750J 520 1190J 280 NJ 280 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 5 410J 530 NJ 530 1210J 300 NJ 300 NJ
preplace netloc v_tpg_0_m_axis_video 1 3 1 1180 80n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 760 150n
preplace netloc v_axi4s_vid_out_0_vid_io_out 1 4 1 1520 80n
levelinfo -pg 1 -30 200 600 1000 1360 1720 1910
pagesize -pg 1 -db -bbox -sgen -30 -110 2110 1390
"
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z010clg400-1 -flow {Vivado Synthesis 2018} -strategy "Flow_RuntimeOptimized" -report_strategy {No Reports} -constrset constrs_1
} else {
